...
public class ShardingJdbcMasterSlaveYamlManager {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 创建数据源
        DataSource dataSource = YamlMasterSlaveDataSourceFactory.createDataSource(new File(Thread.currentThread().getContextClassLoader().getResource("").getPath() + "master-slave.yml"));
        for (int i = 0; i < 10; i++) {
            System.out.println("\r\n");

...
public class LogRecord {
    ...
    private BizCategoryEnum operationCategory;
    ...
    public BizCategoryEnum getOperationCategory() {
        return operationCategory;
    }

    public LogRecord setOperationCategory(BizCategoryEnum operationCategory) {
    ...
    public static final class LogRecordBuilder {
        ...
        public LogRecordBuilder withOperationCategory(BizCategoryEnum operationCategory) {
            this.operationCategory = operationCategory;
            return this;
        }

...
public class LogRecordAspect {
     ...
     */
    @Pointcut("@annotation(com.myz.log.record.annotation.LogRecord)")
    ...
    private void registerSpelFunction(Set<String> registerFunctions, LogRecordEvaluationContext ctx) {
        ...
        while (it.hasNext()) {
            ...
            ctx.registerFunction(funcName, function.functionName());
        }
    }

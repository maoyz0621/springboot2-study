 ...
 */
@Configuration
@MapperScan(basePackages = MybatisDataSource.BASE_PACKAGE, sqlSessionTemplateRef = "baseSqlSessionTemplate")
public class MybatisDataSource extends AbstractDataSource {

    static final String BASE_PACKAGE = "com.myz.springboot2mybatis.module.mapper";
